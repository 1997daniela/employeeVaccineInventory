...
export const ApplicationUserDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="employeeVaccineInventoryApp.applicationUser.delete.question">
        <Translate contentKey="employeeVaccineInventoryApp.applicationUser.delete.question" interpolate={{ id: applicationUserEntity.id }}>
