  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="employeeVaccineInventoryApp.applicationUser.home.createOrEditLabel" data-cy="ApplicationUserCreateUpdateHeading">
            <Translate contentKey="employeeVaccineInventoryApp.applicationUser.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('employeeVaccineInventoryApp.applicationUser.identification')}
                id="application-user-identification"
                name="identification"
              ...
              <ValidatedField
                ...
                label={translate('employeeVaccineInventoryApp.applicationUser.internalUser')}
                type="select"
                required
              >
                <option value="" key="0" />
