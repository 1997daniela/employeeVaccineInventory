...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './vaccine.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VACCINE_LIST actions', async () => {
    ...
    it('dispatches FETCH_VACCINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VACCINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VACCINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VACCINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VACCINE actions', async () => {
      const expectedActions = [
        {
